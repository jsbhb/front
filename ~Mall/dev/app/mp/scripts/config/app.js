...
(function(API){
    ...
    if(!API.jsModel.path){
        Object.defineProperty(API.jsModel, 'path', {
            ...
            value: {
                 ...
                 */
                GOODS_ID_QUERY_NODE:       {
                    host:         DB.debug === true? "https://test.cncoopay.com": "https://m.cncoopay.com",
                 ...
                 */
                MINI_QUERY:    {
                    host:         "https://zserp.cncoopay.com/cardmanager",
    ...
    jump: function(API){
        ...
        if (!isMobile) {
            replaceUrl = protocol + "//" + pcDomain.replace(domainRegex, '$2') + options;
        }
